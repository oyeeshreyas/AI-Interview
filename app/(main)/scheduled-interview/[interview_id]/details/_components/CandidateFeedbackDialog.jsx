...
function CandidateFeedbackDialog({ candidate }) {
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle className='font-bold text-2xl'>Feedback</DialogTitle>
                        ...
                        <div className='mt-5'>
                            ...
                            <div className='mt-5'>
                                ...
                                <div className='mt-3 grid grid-cols-2 gap-10'>
                                    <div>
                                        <h2 className='flex justify-between'>Technical <span>{feedback?.rating?.technicalSkills}/10</span></h2>
                            ...
                            <div className='mt-5'>
                                ...
                                <div className='p-5 border my-3 rounded-md'>
