...
function InterviewLink({interview_id,formData}) {
  ...
  return (
    ...
    <div className='w-full p-7 mt-6 rounded-lg bg-white border border-gray-200 '>
        <div className='flex justify-between items-center'>
            <h2 className='font-bold'>Interview Link</h2>
            <h2 className='p-1 px-2 text-primary bg-white rounded-4xl'>Valid for 30 Days</h2>
        </div>
    ...
    <div className='mt-7 bg-white p-5 rounded-lg w-full border border-gray-200'>
  <h2 className='font-bold'>Share Via</h2>
  <div className='flex space-x-5 gap-4 mt-4 justify-center'>
