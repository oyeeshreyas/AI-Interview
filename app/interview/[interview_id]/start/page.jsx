...
function StartInterview() {
    ...
    const GenerateFeedback = async () => {
        ...
        const jsonMatch = FINAL_CONTENT.match(/{[\s\S]*}/); // Matches the first {...}
        ...
        const parsedFeedback = JSON.parse(jsonMatch[0]); // <-- Parse only the JSON part
        ...
        <div className='p-20 lg:px-48 xl:px-56'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-7 mt-5'>
                <div className='bg-white h-[400px] rounded-lg border flex flex-col gap-3 items-center justify-center'>
                    ...
                    {!activeUser && <span className='absolute inset-0 rounded-full bg-blue-300 opacity-75 animate-ping'></span>}
                    {/* <Image src={''} alt='ai'
                        width={100}
                        height={100}
